...
public class LireDemoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textfieldNumSearchResults.setText("6");
...
//                    "At least some digital image should be found there.", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void helpMenuAboutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpMenuAboutActionPerformed
        JOptionPane.showMessageDialog(this, "<html><center><b>MAC demo for Lucene Image Retrieval (LIRE) library.</b><br>"
                        + "<br>&copy; 2019 by XMU MAC<br></center></html>",
                "About MAC demo", JOptionPane.PLAIN_MESSAGE);
    }//GEN-LAST:event_helpMenuAboutActionPerformed

    private void showAbout() {
        JOptionPane.showMessageDialog(this, "<html><center><b>MAC demo for<br>Lucene Image Retrieval (LIRE) library.</b><br>"
                        + "<br>&copy; 2019 by MAC<br></center></html>",
                "About MAC demo", JOptionPane.PLAIN_MESSAGE);
    }
